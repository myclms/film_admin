...
class Film(models.Model):
    # 电影（ID,片名，年代，类型，拍摄国家,封面链接）
    id = models.AutoField(primary_key=True)
    name = models.CharField(max_length=32, verbose_name='片名')
    year = models.SmallIntegerField(verbose_name='年代', null=True, blank=True)
...
class LoveDir(models.Model):
    ...
    cnt = models.IntegerField(verbose_name='包含电影个数', null=True, blank=True, default=0)
